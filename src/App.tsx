...
function App() {
  ...
  // The color state is a variable (ourColor) monitored by React. When it changes, it will get rerendered to the UI.
  // The elements affected by this, which will be the style of the Header Element ( <header> )
  // The data inside the variable gets stored in the useState (this is part of the React library) which is a React state.
  ...
  // The data inside the ourInputValue variable gets stored in the useState which is a React state.
  ...
  // When the user enters the hex bg colour, React will update its Virtual DOM as that is the component has has changed not the whole physical DOM.
  ...
  return (
    <div className="App">
      ...
      <header className="App-header" style={{backgroundColor: ourColor}}>
       ...
       <h2 data-testid="Title">Use this Input Box to change background colour to your fav colour</h2>

        {/* An input box for user to type their hex colour code to change the background colour. The keystrokes are being stored in the React state
        ...
        setOurColor variable in the React state. Then the bg colour gets updated as React now knows that the bg style has changed. */}
